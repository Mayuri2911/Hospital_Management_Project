...
public class Item extends javax.swing.JFrame {
    ...
    public void AutoID()
    {
        try{
           ...
           {
               jlitem.setText("IU001");
           }
else
           {
                long id= Long.parseLong
                      (rs.getString("MAX(itemid)").substring(2,rs.getString("MAX(itemid)").length()));
                 id++;
               
               jlitem.setText("IU"+String.format("%03d", id));
           }
            connection.close();
...
PreparedStatement stmt = connection.prepareStatement("select *from item");
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Create Item", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 16), new java.awt.Color(0, 51, 153))); // NOI18N
        ...
        jlitem.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jlitem.setForeground(new java.awt.Color(0, 0, 255));
        jlitem.setText("jLabel5");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(48, 48, 48)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jlitem, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qty =jTextField5.getText();
         ...
         try {
                ...
                String query = "insert  into item(itemid,itemname,description,sellprice,buyprice,qty)"
                        + "values(?,?,?,?,?,?)";

                PreparedStatement preparedStmt = connection.prepareStatement(query);
                preparedStmt.setString(1, itemno);
                preparedStmt.setString(2, itemname);
                preparedStmt.setString(3, itemdes);
                preparedStmt.setString(4, sellprice);
                 preparedStmt.setString(5, buyprice);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String qty =jTextField5.getText();
         ...
         try {
                ...
                preparedStmt.setString(2, itemdes);
                preparedStmt.setString(3, sellprice);
                 preparedStmt.setString(4, buyprice);
                  preparedStmt.setString(5, qty);
                    preparedStmt.setString(6, itemno);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jlitem.setText(dl.getValueAt(SelectIndex,0).toString());
